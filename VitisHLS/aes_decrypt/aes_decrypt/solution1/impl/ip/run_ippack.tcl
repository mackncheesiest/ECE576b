...
set Library     "hls"
set IPName      "rijndaelDecrypt_hls"
set Version     "1.0"
set DisplayName "Rijndaeldecrypt_hls"
set Revision    "2104301517"
...
set xo_kernel_name "rijndaelDecrypt_hls"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/localhome/jmack2545/ece576b/VitisHLS/aes_decrypt/aes_decrypt/solution1"
set debug_dir "/localhome/jmack2545/ece576b/VitisHLS/aes_decrypt/aes_decrypt/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {rijndaelDecrypt_hls_Td0
...
## Variables
set Top "rijndaelDecrypt_hls"
set TopNoPrefix "rijndaelDecrypt_hls"
...
set Interfaces {
    s_axi_BUS {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_BUS"
        param_prefix "C_S_AXI_BUS"
        addr_bits "9"
        ...
        memories "ct {base_address 16 range 16} pt {base_address 32 range 16} rk {base_address 256 range 256}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 2 machine 64 combinational 0 latency 183 II x}
...
source -notrace "/media/jmack2545/data_drive/Xilinx/Vitis_HLS/2020.2/common/scripts/ipxhls.tcl"
