...
entity rijndaelDecrypt_hls_Td4s_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of rijndaelDecrypt_hls_Td4s_rom is 
...
entity rijndaelDecrypt_hls_Td4s is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of rijndaelDecrypt_hls_Td4s is
    component rijndaelDecrypt_hls_Td4s_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    rijndaelDecrypt_hls_Td4s_rom_U :  component rijndaelDecrypt_hls_Td4s_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
