; ModuleID = '/localhome/jmack2545/ece576b/VitisHLS/aes_decrypt/aes_decrypt/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline
define void @apatb_rijndaelDecrypt_hls_ir(i32* %rk, i8* %ct, i8* %pt) local_unnamed_addr #0 {
entry:
  ...
  %1 = bitcast i8* %ct to [16 x i8]*
  %2 = bitcast i8* %pt to [16 x i8]*
  call fastcc void @copy_in([44 x i32]* %0, [44 x i32]* nonnull align 512 %rk_copy, [16 x i8]* %1, [16 x i8]* nonnull align 512 %ct_copy, [16 x i8]* %2, [16 x i8]* nonnull align 512 %pt_copy)
  %3 = getelementptr inbounds [44 x i32], [44 x i32]* %rk_copy, i32 0, i32 0
  %4 = getelementptr inbounds [16 x i8], [16 x i8]* %ct_copy, i32 0, i32 0
  %5 = getelementptr inbounds [16 x i8], [16 x i8]* %pt_copy, i32 0, i32 0
  call void @apatb_rijndaelDecrypt_hls_hw(i32* %3, i8* %4, i8* %5)
  call fastcc void @copy_out([44 x i32]* %0, [44 x i32]* nonnull align 512 %rk_copy, [16 x i8]* %1, [16 x i8]* nonnull align 512 %ct_copy, [16 x i8]* %2, [16 x i8]* nonnull align 512 %pt_copy)
  ret void
}
...
declare void @apatb_rijndaelDecrypt_hls_hw(i32*, i8*, i8*)

define void @rijndaelDecrypt_hls_hw_stub_wrapper(i32*, i8*, i8*) #5 {
entry:
  ...
  call void @rijndaelDecrypt_hls_hw_stub(i32* %6, i8* %7, i8* %8)
  call void @copy_in([44 x i32]* null, [44 x i32]* %3, [16 x i8]* null, [16 x i8]* %4, [16 x i8]* null, [16 x i8]* %5)
  ret void
}

declare void @rijndaelDecrypt_hls_hw_stub(i32*, i8*, i8*)
