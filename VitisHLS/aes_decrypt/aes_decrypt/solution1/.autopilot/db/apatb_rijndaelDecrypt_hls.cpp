...
// wrapc file define:
#define AUTOTB_TVIN_rk "../tv/cdatafile/c.rijndaelDecrypt_hls.autotvin_rk.dat"
#define AUTOTB_TVOUT_rk "../tv/cdatafile/c.rijndaelDecrypt_hls.autotvout_rk.dat"
// wrapc file define:
#define AUTOTB_TVIN_ct "../tv/cdatafile/c.rijndaelDecrypt_hls.autotvin_ct.dat"
#define AUTOTB_TVOUT_ct "../tv/cdatafile/c.rijndaelDecrypt_hls.autotvout_ct.dat"
// wrapc file define:
#define AUTOTB_TVIN_pt "../tv/cdatafile/c.rijndaelDecrypt_hls.autotvin_pt.dat"
#define AUTOTB_TVOUT_pt "../tv/cdatafile/c.rijndaelDecrypt_hls.autotvout_pt.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_rk "../tv/rtldatafile/rtl.rijndaelDecrypt_hls.autotvout_rk.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_ct "../tv/rtldatafile/rtl.rijndaelDecrypt_hls.autotvout_ct.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_pt "../tv/rtldatafile/rtl.rijndaelDecrypt_hls.autotvout_pt.dat"
...
extern "C" void rijndaelDecrypt_hls_hw_stub_wrapper(volatile void *, volatile void *, volatile void *);
  ...
  if (wrapc_switch_file_token.good())
  {
    ...
    string AESL_num;{
      ...
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_pt);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > pt_pc_buffer(16);
          int i = 0;

          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){

            RTLOutputCheckAndReplacement(AESL_token, "pt");
  
            // push token into output port buffer
            if (AESL_token != "") {
              pt_pc_buffer[i] = AESL_token.c_str();;
              i++;
            }
          ...
          if (i > 0) {{
            ...
            ((char*)__xlx_apatb_param_pt)[j] = pt_pc_buffer[i].to_int64();
          }}}
        } // end transaction
      } // end file is good
...
rijndaelDecrypt_hls_hw_stub_wrapper(__xlx_apatb_param_rk, __xlx_apatb_param_ct, __xlx_apatb_param_pt);
CodeState = DUMP_OUTPUTS;
// print pt Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVOUT_pt, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_pt = 0*1;
  if (__xlx_apatb_param_pt) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_pt)[j];
