...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "activity_kernel.autotvin.dat"
	set constFileTvOut       "activity_kernel.autotvout.dat"
	set constFileHdlTvIn     "activity_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "activity_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
