...
$(ObjDir)/activity.c_pre.c.tb.o : activity.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) activity.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/activity_kernel.c_pre.c.tb.o : activity_kernel.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) activity_kernel.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
