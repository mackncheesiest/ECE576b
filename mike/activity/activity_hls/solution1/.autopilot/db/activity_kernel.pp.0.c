...
# 314 "/tools/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
# 2 "activity_kernel.c" 2

__attribute__((sdx_kernel("activity_kernel", 0))) void activity_kernel(int len, double* hr, double* t, double* meanhr, double* tpower, double* stationarity, double* activity, double* acmin, double* hrmin, double* stmin, double* tpmin, double* tmin0, double* tmin1) {
#pragma HLS TOP name=activity_kernel
# 3 "activity_kernel.c"
      ...
      VITIS_LOOP_11_1: for (i = 0 ; i < len / 2 ; i++) {
        meanhr0 += hr[i];
      }

      VITIS_LOOP_15_2: for (; i < len ; i++) {
        meanhr1 += hr[i];
      }
      ...
      *stationarity = meanhr0 - meanhr1;
      ...
      VITIS_LOOP_28_3: for (i = 0 ; i < len ; i++) {
        p = hr[i] - *meanhr;
        *tpower += p * p;
      }
