...
set id 1
set name activity_kernel_dadddsub_64ns_64ns_64_2_full_dsp_1
...
set id 2
set name activity_kernel_dsub_64ns_64ns_64_2_full_dsp_1
...
set id 3
set name activity_kernel_dmul_64ns_64ns_64_2_max_dsp_1
...
set id 5
set name activity_kernel_ddiv_64ns_64ns_64_6_no_dsp_1
...
set id 7
set name activity_kernel_dcmp_64ns_64ns_1_1_no_dsp_1
...
set id 9
set name activity_kernel_sitodp_32ns_64_2_no_dsp_1
...
set id 10
set name activity_kernel_dsqrt_64ns_64ns_64_6_no_dsp_1
...
set id 11
set name activity_kernel_dacc_64ns_64ns_1ns_64_3_no_dsp_1
set corename simcore_dacc
set op dacc
set stage_num 3
set max_latency -1
set registered_input 1
...
set ce_width 1
set ce_signed 0
set in_data_width 64
set in_data_signed 0
set in_last_width 1
set in_last_signed 0
set in_valid_width 1
set in_valid_signed 0
set out_data_width 64
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_dacc] == "ap_gen_simcore_dacc"} {
eval "ap_gen_simcore_dacc { \
    id ${id} \
    name ${name} \
    corename ${corename} \
    op ${op} \
...
puts "@W \[IMPL-100\] Cannot find ap_gen_simcore_dacc, check your AutoPilot builtin lib"
}
}
...
set op dacc
set corename DAcc_nodsp
if {${::AESL::PGuard_autocg_gen} && (${::AESL::PGuard_autocg_fpip} || ${::AESL::PGuard_autocg_fpv6en} || ${::AESL::PGuard_autocg_hpen})} {
if {[info proc ::AESL_LIB_XILINX_FPV6::dacc_gen] == "::AESL_LIB_XILINX_FPV6::dacc_gen"} {
eval "::AESL_LIB_XILINX_FPV6::dacc_gen { \
    id ${id} \
    name ${name} \
    corename ${corename} \
    op ${op} \
...
puts "@W \[IMPL-101\] Cannot find ::AESL_LIB_XILINX_FPV6::dacc_gen, check your platform lib"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_meanhr \
    op interface \
    ports { meanhr { O 64 vector } meanhr_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_tpower \
    op interface \
    ports { tpower { O 64 vector } tpower_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_stationarity \
    op interface \
    ports { stationarity { O 64 vector } stationarity_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_activity \
    op interface \
    ports { activity { O 64 vector } activity_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_acmin \
    op interface \
    ports { acmin_i { I 64 vector } acmin_o { O 64 vector } acmin_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_hrmin \
    op interface \
    ports { hrmin { O 64 vector } hrmin_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_stmin \
    op interface \
    ports { stmin { O 64 vector } stmin_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_tpmin \
    op interface \
    ports { tpmin { O 64 vector } tpmin_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_tmin0 \
    op interface \
    ports { tmin0 { O 64 vector } tmin0_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_tmin1 \
    op interface \
    ports { tmin1 { O 64 vector } tmin1_ap_vld { O 1 bit } } \
} "
}
